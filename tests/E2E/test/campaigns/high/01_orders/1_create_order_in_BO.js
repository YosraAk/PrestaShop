...
scenario('Create order in the Back Office', () => {
  ...
  scenario('Check the created order in the Back Office', client => {
    ...
    test('should check that the "order message" is equal to "Order message test"', () => client.checkTextValue(OrderPage.message_order, 'Order message test','contain', 3000));
    ...
    test('should check that the "customer" is equal to "John DOE"', () => client.checkTextValue(OrderPage.customer_name, 'John DOE', "contain", 2000));
